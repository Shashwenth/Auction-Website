...
int i=st.executeUpdate("update login set isrep=true where id='"+id+"';");
out.println("Thank you for adding a new rep ! Please <a href=Admin_welcome.jsp>Login</a> to continue.");
}
catch(Exception e)
{
System.out.print(e);
...
response.sendRedirect("test_admin.html");
%>
