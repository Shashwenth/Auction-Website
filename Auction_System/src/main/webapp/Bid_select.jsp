...
String sql ="SELECT * FROM bids where" + " item_id="+Integer.valueOf(item_id)+";";
...
<td><%=id %></td>
<td><%=amount %></td>
<td><a href="Bid_Remove.jsp?b_id=<%=resultSet.getString("b_id")%>&item_id=<%=item_id%>&id=<%=id%>">Bid</a></td>
</tr>
<% 
}
