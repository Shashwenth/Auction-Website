...
int i=st.executeUpdate("update AuctionList set IsLive = true where" + " Auc_id='"+username+"';");
}catch(Exception e)
{
System.out.print(e);
e.printStackTrace();
...
%>
<h2>Auction <%= username %> ! Go To <a href=Admin_welcome.jsp>Selection</a> to continue.</h2>
