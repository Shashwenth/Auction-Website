...
int i=st.executeUpdate("insert into faq(question,answer )values('"+question+"','"+answer+"');");

int ix=st.executeUpdate("insert into qalert(id,question,answer )values('"+id+"','"+question+"','"+answer+"');");
}catch(Exception e)
{
System.out.print(e);
e.printStackTrace();
...
try{
	Class.forName("com.mysql.jdbc.Driver");
	Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/auctionsys","root","sasumithu");
	String deleteQuery = "DELETE FROM questions WHERE q_id = ?";
	try (PreparedStatement deleteStatement = conn.prepareStatement(deleteQuery)) {
	    deleteStatement.setInt(1, Integer.valueOf(qid));
